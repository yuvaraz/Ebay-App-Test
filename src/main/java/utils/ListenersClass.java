 ...
 *
 */
public class ListenersClass implements IReporter, ITestListener{
		
	// When Test case get Started, this method is called.	
	public void onTestStart(ITestResult result) {
		// TODO Auto-generated method stub
		//System.out.println("Tests case started:"  + result.getMethod().getMethodName() + " at:" + result.getStartMillis());
	...
	public void onTestFailedButWithinSuccessPercentage(ITestResult result) {
		// TODO Auto-generated method stub
		 System.out.println("Test case-  " +result.getName() + ": Failed but within success");
	}
	public void onStart(ITestContext context) {
		// TODO Auto-generated method stub
		//System.out.println("Total current test cases:\n " + context.getIncludedGroups());
	...
	private static final Logger L = Logger.getLogger(EmailableReporter.class);
	 private PrintWriter m_out;
	  ...
	  private String fileName = "emailablestatus-report.html";
	   ...
	   // tableColumnStart("Excluded<br/>Groups");
	    ...
	    for (ISuite suite : suites) {
	      ...
	      for (ISuiteResult r : tests.values()) {
	        ...
	        qty_skip += q;
	        summaryCell(q,0);
	       /* q = getMethodSet(overview.getSkippedTests(), suite).size()+getMethodSet(overview.getFailedTests(), suite).size()+getMethodSet(overview.getPassedTests(), suite).size();
	        qty_total += q;
	        summaryCell(q,0);*/
	        time_start = Math.min(overview.getStartDate().getTime(), time_start);
	        time_end = Math.max(overview.getEndDate().getTime(), time_end);
	        summaryCell(formatter.format(
	            ((overview.getEndDate().getTime() - overview.getStartDate().getTime()) / 1000.)/60.)
	            + " minutes", true);
